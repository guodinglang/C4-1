...
{"slot",ReadSelectSwitch1,
 "Slot1:M1 1,x                //set switch x(solt) x(Device) x(in) x(?/out)\r\n"
},
{"max",ReadWriteMaxCH,
...
{"srw",SetReadWrite,
 "SRW x x x                   //Set read write x(W/R) x[ls-(level save)/bs-boost(1-OFF,2-ON,3-650KHZ,4-1.1MHZ)/EC-error code/pps]\r\n"
},
